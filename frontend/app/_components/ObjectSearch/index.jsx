...
import { OBJECT_LABELS } from "@/_constants/object_labels";
import Autocomplete from '../Autocomplete';
import { useDispatch, useSelector } from 'react-redux';
import { setObjectData } from "@/_store/slices/searchSlice";
...
const ObjectSearch = () => {
  ...
  const onMouseUp = useCallback(() => {
    ...
    const newObject = [...objectData, normalized]
    dispatch(setObjectData(newObject));
