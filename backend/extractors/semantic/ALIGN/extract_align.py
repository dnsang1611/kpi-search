...
feature_extractor = AutoProcessor.from_pretrained("kakaobrain/align-base", device='cuda')


args = parse_args()
device = 'cuda'
keyframes_folder = '/mnt/mmlab2024nas/visedit/AIC2024/code/Data/Newframe'
# keyframes_folder = '/mnt/mmlab2024nas/visedit/AIC2024/code/Data/batch3_Newframe'

features_dir = '/mnt/mmlab2024nas/visedit/AIC2024/code/Features/ALIGN'
        ...
        for subfolder_name in natsorted(os.listdir(folder_path)):
            ...
            if os.path.isdir(subfolder_path):
                ...
                for image_idx, image_name in enumerate(image_paths):
                    ...
                    image_emb_np = image_embedding.cpu().detach().numpy()
