# # Định nghĩa đường dẫn file và ký tự SEPARATOR
# file_path = '/mnt/mmlabworkspace/Students/visedit/AIC2024/Backend/ASR/transcription_checkpoint/batch1.txt'
# separator = 'SEPERATOR'
...
# # Nếu tìm thấy SEPARATOR, cắt nội dung từ dòng đó trở xuống
# if cut_line is not None:
#     lines = lines[:cut_line]

# # Ghi nội dung đã cắt vào lại file
...
TRANSCRIPTION_CHECKPOINT_PATH = '/mnt/mmlab2024nas/visedit/AIC2024/code/Backend/ASR/transcription_checkpoint/batch3_3.txt'
CHECKPOINT_PATH = '/mnt/mmlab2024nas/visedit/AIC2024/code/Backend/ASR/checkpoints/batch3.txt'
START_LINE_INDEX = 303381  # Thay đổi giá trị này nếu cần bắt đầu từ dòng khác
END_LINE_INDEX = 330000  # Đặt giá trị None nếu muốn đọc đến hết file hoặc chỉ định số dòng kết thúc
