...
_PREDEFINED_SPLITS_TEXT = {
    ...
    # Vietnamese
    "vintext_train": ("vintext/train_images", "vintext/corrected_train.json"),
    ...
    "vintext_val": ("vintext/val_images", "vintext/corrected_val.json"),
    "vintext_test": ("vintext/test_images", "vintext/test.json")
}
